...
_PARAMETERS_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        ...
        "page_labels": {
            ...
            "minItems": 1,
            "maxItems": 20,
            "description": "Page labels returned by tool_content_get_structure.",
        },
    },
...
class ToolContentPageReadResult:
    content_id: str
    items: list[ToolContentPageReadItem] = field(default_factory=list)
        ...
        self._definition = ToolDefinition(
            llm_spec=ToolLLMSpec(
                ...
                description=(
                    ...
                    "WHEN TO TRIGGER:\n"
                    "  - MUST trigger when tool_content_get_structure or a previous result identifies "
